...
==========================================================================================
ConditionalUNet3D_FiLM                   [2, 1, 16, 84, 84]        --
...
├─Down3D: 1-3                            [2, 64, 8, 42, 42]        --
│    └─MaxPool3d: 2-3                    [2, 32, 8, 42, 42]        --
│    └─DoubleConv3D: 2-4                 [2, 64, 8, 42, 42]        --
│    │    └─Sequential: 3-7              [2, 64, 8, 42, 42]        166,144
│    └─FiLM: 2-5                         [2, 64, 1, 1, 1]          --
│    │    └─Linear: 3-8                  [2, 128]                  98,432
├─Down3D: 1-4                            [2, 128, 4, 21, 21]       --
│    └─MaxPool3d: 2-6                    [2, 64, 4, 21, 21]        --
│    └─DoubleConv3D: 2-7                 [2, 128, 4, 21, 21]       --
│    │    └─Sequential: 3-9              [2, 128, 4, 21, 21]       664,064
│    └─FiLM: 2-8                         [2, 128, 1, 1, 1]         --
│    │    └─Linear: 3-10                 [2, 256]                  196,864
├─DoubleConv3D: 1-5                      [2, 256, 4, 21, 21]       --
│    └─Sequential: 2-9                   [2, 256, 4, 21, 21]       --
│    │    └─Conv3d: 3-11                 [2, 256, 4, 21, 21]       884,736
│    │    └─BatchNorm3d: 3-12            [2, 256, 4, 21, 21]       512
│    │    └─ReLU: 3-13                   [2, 256, 4, 21, 21]       --
│    │    └─Conv3d: 3-14                 [2, 256, 4, 21, 21]       1,769,472
│    │    └─BatchNorm3d: 3-15            [2, 256, 4, 21, 21]       512
│    │    └─ReLU: 3-16                   [2, 256, 4, 21, 21]       --
├─FiLM: 1-6                              [2, 256, 1, 1, 1]         --
│    └─Linear: 2-10                      [2, 512]                  393,728
├─Up3D: 1-7                              [2, 128, 4, 21, 21]       --
│    └─Upsample: 2-11                    [2, 256, 8, 42, 42]       --
│    └─Conv3d: 2-12                      [2, 128, 8, 42, 42]       32,896
│    └─DoubleConv3D: 2-13                [2, 128, 4, 21, 21]       --
│    │    └─Sequential: 3-17             [2, 128, 4, 21, 21]       1,327,616
│    └─FiLM: 2-14                        [2, 128, 1, 1, 1]         --
│    │    └─Linear: 3-18                 [2, 256]                  196,864
├─Up3D: 1-8                              [2, 64, 8, 42, 42]        --
│    └─Upsample: 2-15                    [2, 128, 8, 42, 42]       --
│    └─Conv3d: 2-16                      [2, 64, 8, 42, 42]        8,256
│    └─DoubleConv3D: 2-17                [2, 64, 8, 42, 42]        --
│    │    └─Sequential: 3-19             [2, 64, 8, 42, 42]        332,032
│    └─FiLM: 2-18                        [2, 64, 1, 1, 1]          --
│    │    └─Linear: 3-20                 [2, 128]                  98,432
├─Up3D: 1-9                              [2, 32, 16, 84, 84]       --
│    └─Upsample: 2-19                    [2, 64, 16, 84, 84]       --
│    └─Conv3d: 2-20                      [2, 32, 16, 84, 84]       2,080
│    └─DoubleConv3D: 2-21                [2, 32, 16, 84, 84]       --
│    │    └─Sequential: 3-21             [2, 32, 16, 84, 84]       83,072
│    └─FiLM: 2-22                        [2, 32, 1, 1, 1]          --
│    │    └─Linear: 3-22                 [2, 64]                   49,216
├─Conv3d: 1-10                           [2, 1, 16, 84, 84]        33
==========================================================================================
Total params: 6,382,817
Trainable params: 6,382,817
Non-trainable params: 0
Total mult-adds (Units.GIGABYTES): 57.24
==========================================================================================
Input size (MB): 0.91
Forward/backward pass size (MB): 738.81
Params size (MB): 25.53
Estimated Total Size (MB): 765.25
==========================================================================================
"""